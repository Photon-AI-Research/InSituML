...
path_to_supercells = '/bigdata/hplsim/aipp/Anna/lwfa_tests/'
...
for ind, series in enumerate(all_series):
    ...
    print(tmp_x1_unique.shape, tmp_y1_unique.shape, tmp_z1_unique.shape)
    
    xnum = tmp_x1_unique[::20] // 8
    ynum = tmp_y1_unique[::20] // 8
    znum = tmp_z1_unique[::20] // 4
