...
items = [path_to_radiation_data + '/' + next_file for next_file in os.listdir(path_to_radiation_data)]
...
vmin, vmax = torch.torch.full(arr.shape, vmin),  torch.torch.full(arr.shape, vmax)
