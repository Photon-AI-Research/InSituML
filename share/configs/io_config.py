...
streamLoader_config = dict(
    ...
    # files on frontier
    # pathpattern2 = "/lustre/orion/csc380/world-shared/ksteinig/
    #     002_KHI_withRad_randomInit_data-subset/radiationOpenPMD/
    # e_radAmplitudes%T.bp", # files on frontier
    amplitude_direction=0,  # choose single direction along which the
    #    radiation signal is observed, max: N_observer-1, where N_observer is
