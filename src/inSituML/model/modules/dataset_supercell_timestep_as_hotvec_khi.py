...
class PCDataset(Dataset):
    def __init__(self, items_phase_space, normalize=False, a=0.0, b=1.0):
        """
        Prepare dataset
        Args:
        ...
        self.vmin_rad, self.vmax_rad = (
            ...
            torch.Tensor(
                [0.15, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3, 0.3]
            ).float(),
        )
    ...
    def __getitem__(self, index):
        ...
        return (
            ...
            self.get_time(
                data_preprocessing.get_time(self.items_ps[index]),
                self.timesteps,
            ),
        )
