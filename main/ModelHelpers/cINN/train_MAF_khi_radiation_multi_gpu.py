...
if __name__ == "__main__":
    ...
    num_blocks_mat = 2,
    activation = 'gelu',
    pathpattern1 = "/lustre/orion/csc372/proj-shared/vineethg/khi/part_rad/particle_002/{}.npy",
    pathpattern2 = "/lustre/orion/csc372/proj-shared/vineethg/khi/part_rad/radiation_002_ex/{}.npy"
    )
    ...
    directory ='/lustre/orion/csc372/world-shared/checkpoints/maf_khi/'+str(wandb.run.id)
