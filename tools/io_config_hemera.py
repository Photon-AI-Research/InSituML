...
streamLoader_config = dict(
    t0 =  895,
    t1 = 998, # endpoint=false, t1 is not used in training
    # t0 =  1800,
   ...
   # pathpattern2 = "/bigdata/hplsim/production/KHI_for_GB_MR/runs/014_KHI_007_noWindowFunction/simOutput/radiationOpenPMD/e_radAmplitudes%T.bp", # files on hemera
     pathpattern1 = "/bigdata/hplsim/aipp/SC24_PIConGPU-Continual-Learning/24-nodes_full-picongpu-data/04-01_1013/simOutput/openPMD/simData_%T.bp5", # files on hemera
     pathpattern2 = "/bigdata/hplsim/aipp/SC24_PIConGPU-Continual-Learning/24-nodes_full-picongpu-data/04-01_1013/simOutput/radiationOpenPMD/e_radAmplitudes_%T.bp5", # files on hemera
...
batch_size=int(environ["BATCH_SIZE"]) if "BATCH_SIZE" in environ else 2
