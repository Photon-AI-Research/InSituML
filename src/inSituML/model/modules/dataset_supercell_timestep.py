...
class PCDataset(Dataset):
    def __init__(self, 
        ...
        if normalize:
            ...
            self.vmin_rad_, self.vmax_rad_ = data_preprocessing.get_vmin_vmax_radiation_np(self.items_rad,1, data_preprocessing.get_radiation_spectra_2_projections)
    ...
    def __getitem__(self, index):
        ...
        self.vmin_rad, self.vmax_rad = torch.full((x.shape[0],512), self.vmin_rad_), torch.full((x.shape[0], 512), self.vmax_rad_)
