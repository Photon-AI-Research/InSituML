...
path_to_supercells_indices = '/bigdata/hplsim/aipp/Anna/supercells_indices_magnRec/'
path_to_all_simulations = "/bigdata/hplsim/production/2023-02_magnetic-reconnection/010_radiation-example/simOutput/openPMD/"
...
for ind, series in enumerate(all_series):
    ...
    for chunk_num in range(100000000):
        ...
        print("Supercells in x: ", tmp_x1_unique)
        print("Supercells in y: ", tmp_y1_unique)
        print("Supercells in z: ", tmp_z1_unique)
