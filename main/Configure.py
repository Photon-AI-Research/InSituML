...
class Configurer:
    ...
    def parseArguments(self):
        ...
        parser.add_argument("--onFFT", type=bool, help='Train on FFT of Efield', default = False)
        parser.add_argument("--onFFTproperty", type=str, help='Property of FFT of Efield', default = 'magnitude')
