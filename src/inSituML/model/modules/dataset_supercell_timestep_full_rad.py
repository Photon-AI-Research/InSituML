...
class PCDataset(Dataset):
    def __init__(self, 
        ...
        if normalize:
            ...
            self.vmin_rad_, self.vmax_rad_ = data_preprocessing.get_vmin_vmax_radiation_np(self.items_rad,1, self.get_data_radiation)
    ...
    def __getitem__(self, index):
        ...
        self.vmin_rad, self.vmax_rad = torch.full((x.shape[0],65536), self.vmin_rad_), torch.full((x.shape[0], 65536), self.vmax_rad_)
